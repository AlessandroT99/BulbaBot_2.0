...
servoList = [sxTF.pin,sxTM.pin,sxTR.pin,sxFF.pin,sxFM.pin,sxFR.pin]
servoString = ""
for i in servoList:
	servoString = servoString + str(i) + ","
servoInit = '/home/ubuntu/servoblaster/servod --p1pins="%s" --pcm &' %servoString[:-1]
system(servoInit)

sleep(1)

echoAngle(sxFF.snum,sxFF.angle)
echoAngle(sxFM.snum,sxFM.angle)
echoAngle(sxFR.snum,sxFR.angle)
