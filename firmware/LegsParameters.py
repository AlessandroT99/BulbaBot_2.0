...
SX_MIN_SHOULDER     = 0     #behind the head
SX_DEFAULT_SHOULDER = 90    #default angle

SX_MAX_FEMUR        = 50    #raise
SX_MIN_FEMUR        = 180   #lowest position
SX_DEFAULT_FEMUR    = 90    #default angle

SX_MAX_TIBIA        = 0     #raise
SX_MIN_TIBIA        = 180   #lowest position
SX_DEFAULT_TIBIA    = 50    #default angle

DX_MAX_SHOULDER     = 0     #towards the head
DX_MIN_SHOULDER     = 180   #behind the head
DX_DEFAULT_SHOULDER = 90    #default angle

DX_MAX_FEMUR        = 130   #raise
DX_MIN_FEMUR        = 0     #lowest position
DX_DEFAULT_FEMUR    = 90    #default angle

DX_MAX_TIBIA        = 180   #raise
DX_MIN_TIBIA        = 0     #lowest position
DX_DEFAULT_TIBIA    = 150   #default angle
